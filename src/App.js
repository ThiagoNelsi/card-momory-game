...
function App() {
  ...
  let colors = ['#7e40e29d', '#7e40e29d', '#4086e29d', '#4086e29d', '#4de2409d', '#4de2409d', '#dcec00ce', '#dcec00ce', '#ec8600b9', '#ec8600b9', '#002c12b7', '#002c12b7', '#2c0000b7', '#2c0000b7', '#af00a6b7', '#af00a6b7', '#04cec3b7', '#04cec3b7', '#fbfbfbb7', '#fbfbfbb7'];
    ...
    if (element.classList.contains('turned')) {
      ...
      if (turned.length === 0) {
        ...
        setTimeout(() => {
          ...
          if (turned[0].color === turned[1].color && turned[0].key !== turned[1].key) {
  ...
  return (
    <div className='container'>
      <div className='game-container'>
        {items.map(item => <div id={item.key} key={item.key} onClick={() => !corrects.includes(item.key) && canClick ? handleClick(item) : null}></div>)}
      </div>
    </div>
  );
}
